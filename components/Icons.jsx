/* Icons + shared UI primitives for ShortsForge */
/* All icons are stroke-based, 18px default, currentColor. */
...
const Icon = ({ name, size = 18, className = '', style = {} }) => {
  ...
  switch (name) {
    ...
    case 'doc':
      return <svg {...common}><path d="M6 3h8l4 4v14a1 1 0 0 1-1 1H6a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1z"/><path d="M14 3v4h4M8 12h8M8 16h6"/></svg>;
    case 'user':
      return <svg {...common}><circle cx="12" cy="8" r="3.5"/><path d="M4 20c1.5-3.5 4.5-5 8-5s6.5 1.5 8 5"/></svg>;
    case 'image':
      return <svg {...common}><rect x="3" y="4" width="18" height="16" rx="2"/><circle cx="9" cy="10" r="1.5"/><path d="m3 17 5-4 4 3 3-2 6 4"/></svg>;
    case 'video':
      return <svg {...common}><rect x="3" y="6" width="13" height="12" rx="2"/><path d="m16 10 5-3v10l-5-3z"/></svg>;
    case 'film':
      return <svg {...common}><rect x="3" y="4" width="18" height="16" rx="1"/><path d="M3 8h18M3 16h18M7 4v16M17 4v16"/></svg>;
    case 'layers':
      return <svg {...common}><path d="m12 3 9 5-9 5-9-5z"/><path d="m3 13 9 5 9-5M3 18l9 5 9-5"/></svg>;
    case 'play':
      return <svg {...common} fill="currentColor" stroke="none"><path d="M7 4v16l13-8z"/></svg>;
    case 'pause':
    ...
    case 'search':
      return <svg {...common}><circle cx="11" cy="11" r="7"/><path d="m21 21-4.5-4.5"/></svg>;
    case 'settings':
    ...
    case 'refresh':
      return <svg {...common}><path d="M4 12a8 8 0 0 1 14-5.3L20 9M20 4v5h-5M20 12a8 8 0 0 1-14 5.3L4 15M4 20v-5h5"/></svg>;
    case 'wand':
      return <svg {...common}><path d="m15 4 2 2-11 11-2-2zM13 6l2 2M18 3v4M16 5h4M19 14v2M18 15h2"/></svg>;
    case 'zap':
      return <svg {...common}><path d="M13 2 4 14h7l-1 8 9-12h-7z"/></svg>;
    case 'clock':
      return <svg {...common}><circle cx="12" cy="12" r="9"/><path d="M12 7v5l3 2"/></svg>;
    case 'type':
      return <svg {...common}><path d="M4 7V5h16v2M9 5v14M15 5v14M7 19h4M13 19h4"/></svg>;
    case 'camera':
      return <svg {...common}><rect x="3" y="7" width="18" height="13" rx="2"/><circle cx="12" cy="13.5" r="3.5"/><path d="M8 7l1.5-3h5L16 7"/></svg>;
    case 'music':
    ...
    case 'edit':
      return <svg {...common}><path d="m4 20 4-1 11-11-3-3L5 16l-1 4z"/></svg>;
    case 'lock':
      return <svg {...common}><rect x="5" y="11" width="14" height="10" rx="2"/><path d="M8 11V7a4 4 0 0 1 8 0v4"/></svg>;
    case 'circle':
      return <svg {...common}><circle cx="12" cy="12" r="9"/></svg>;
    case 'cube':
      return <svg {...common}><path d="M12 3 3 7.5v9L12 21l9-4.5v-9zM3 7.5 12 12l9-4.5M12 12v9"/></svg>;
    case 'split':
      return <svg {...common}><path d="M16 3h5v5M21 3l-7 7M8 21H3v-5M3 21l7-7M14 14l7 7M10 10 3 3"/></svg>;
    case 'bell':
      return <svg {...common}><path d="M6 9a6 6 0 1 1 12 0v4l2 3H4l2-3z"/><path d="M10 20a2 2 0 0 0 4 0"/></svg>;
    case 'mic':
...
// Avatar placeholder (no face drawing - uses initials + gradient)
const Avatar = ({ name, chip = 'mint', size = 40 }) => {
